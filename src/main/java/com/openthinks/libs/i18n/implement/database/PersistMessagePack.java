 ...
 * @version V1.0 
 */
package com.openthinks.libs.i18n.implement.database;

import java.io.Serializable;
import java.util.Locale;

import com.openthinks.libs.i18n.AbstractMessagePack;
import com.openthinks.libs.i18n.IMessage;
import com.openthinks.libs.i18n.implement.database.query.QueryEngine;
...
public final class PersistMessagePack extends AbstractMessagePack {
	 ...
	 * @return String
	 */
	protected String queryContent(Serializable messageId, Locale locale) {
		return QueryEngine.get().query(packName, messageId, locale);
	}
